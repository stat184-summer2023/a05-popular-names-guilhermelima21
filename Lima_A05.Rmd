...
Count is renamed as "Popularity" on the Y-axis (it appears that they may have transformed this in some way because from the summary function we see the max count is 99,674, but the graph appears to have a max count of ~52,000) 
